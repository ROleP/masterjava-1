...
public class MailServiceClient {
    ...
    public static void main(String[] args) throws MalformedURLException {
        ...
        ImmutableSet<Addressee> addressees = ImmutableSet.of(
                new Addressee("Мастер Java <_rolep_@mail.ru>"));

        List<Attach> attaches = ImmutableList.of(new Attach("version.html", new DataHandler(new File("config/version.html").toURI().toURL())));
