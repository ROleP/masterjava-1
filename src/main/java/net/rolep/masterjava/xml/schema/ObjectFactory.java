 ...
 * generated in the net.rolep.masterjava.xml.schema package. 
...
public class ObjectFactory {
    ...
    private final static QName _City_QNAME = new QName("http://rolep.net", "City");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: net.rolep.masterjava.xml.schema
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://rolep.net", name = "City")
