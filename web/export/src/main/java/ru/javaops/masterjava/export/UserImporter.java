...
public class UserImporter {
    ...
    public List<PayloadImporter.FailedEmail> process(StaxStreamProcessor processor, Map<String, City> cities, int chunkSize) throws XMLStreamException {
        ...
        return new Callable<List<PayloadImporter.FailedEmail>>() {
            ...
            public List<PayloadImporter.FailedEmail> call() throws XMLStreamException {
                ...
                while (processor.doUntil(XMLEvent.START_ELEMENT, "User")) {
                    ...
                    if (city == null) {
                        failed.add(new PayloadImporter.FailedEmail(email, "City '" + cityRef + "' is not present in DB"));
                    } else {
